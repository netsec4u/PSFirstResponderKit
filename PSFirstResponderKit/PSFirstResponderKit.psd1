...
GUID = '39058f62-7c35-4df2-a250-f5c01075bbcb'
...
Description = 'Collection of PowerShell functions to execute First Responder Kit stored procedures.'
...
TypesToProcess = @(
	'PSFirstResponderKit.Types.ps1xml'
)

# Format files (.ps1xml) to be loaded when importing this module
FormatsToProcess = @(
	'PSFirstResponderKit.Format.ps1xml'
)
...
PrivateData = @{
	...
	PSData = @{
		...
		ProjectUri = 'https://github.com/netsec4u/PSFirstResponderKit'
